 ...
 *   2) re-labels the energy-range panel to per-slot + line-loading (thermal)
...
(function () {
    ...
    function renderMarket() {
      ...
      <div class="dash-section">
        ...
        <p class="algo-note">ตลาดราย 1 ชม. · พลังงาน = kWh ต่อ slot · เพดาน ~16 kWh/seller, ~15 kWh/buyer · ราคา [${FIT_PRICE}, ${RETAIL_PRICE}]</p>
    ...
    // ── Re-label the energy-range panel: per-slot + line loading (thermal) ────
    window.renderEnergyRangeBanner = function () {
      ...
      <div class="era-card">
        ...
        <div class="era-grid">
          ...
          <div class="era-stat"><span class="era-label">Max / Seller <span style="font-size:0.75em;opacity:0.8">(line loading)</span></span>
          ...
          <div class="era-stat"><span class="era-label">Min / Buyer</span>
            <span class="era-value green">0 kWh</span></div>
          <div class="era-stat"><span class="era-label">Max / Buyer <span style="font-size:0.75em;opacity:0.8">(line loading)</span></span>
        ...
        <div class="era-note">
          ...
          <span style="font-size:0.9em; opacity:0.9;">
            *หมายเหตุ: ค่าเป็นพลังงานต่อ slot 1 ชม. (ENERGY_WINDOW = 1.0) เมื่อสายส่งถูกลดพิกัดเป็น 0.34/3 kA ตัวที่ชนก่อนคือ line loading (thermal) ที่ ~100% ก่อนที่แรงดันจะหลุดกรอบ 0.95–1.05 p.u. ดังนั้นเพดานนี้คุมด้วย thermal เป็นหลัก ไม่ใช่ over/undervoltage
          </span>
        </div>
        <div class="era-warning">⚠️ พลังงานเกินเพดานจะเกิด line loading (thermal) ก่อน แล้วจึง over/undervoltage · ปรับ input ให้ไม่เกินค่านี้ต่อ slot</div>
      </div>`;
    };
